...
- **Numbers and units** — Keep format: $65.7 billion, 67% YoY, 42%, $5.2 million. Don't convert to "bilhões de dólares" — the audience reads dollar notation
...
- **Verify numbers and proper nouns survived intact.** $65.7 billion must not become $65,7 bilhões. Names must not be misspelled or altered.
