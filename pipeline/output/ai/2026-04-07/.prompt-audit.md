...
Read these files:
- **Article**: `/Users/guilherme/ai-newsletter/pipeline/output/ai/2026-04-07/pt.md`
- **Research**: `/Users/guilherme/ai-newsletter/pipeline/output/ai/2026-04-07/research.json` (for source context — dates, excerpts)

## Process

1. Read both files.
2. For each distinct event in the article, check when it actually happened. Use research.json first (check `published_at` fields and excerpts). If unclear, use `exa_search` to find the original announcement date.
...
Write `/Users/guilherme/ai-newsletter/pipeline/output/ai/2026-04-07/audit.json`:
