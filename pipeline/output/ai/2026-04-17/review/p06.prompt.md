Você é um revisor paralelo do draft de newsletter de **2026-04-17**. Outros Claudes estão revisando outros parágrafos simultaneamente em outras janelas do tmux. Você é responsável **APENAS pelo parágrafo 06**.
...
- `pipeline/output/ai/2026-04-17/review/p06.in.md` — **o SEU parágrafo** (a fonte congelada)
- `pipeline/output/ai/2026-04-17/review/p06.out.md` — onde você grava a versão aprovada (começa igual ao .in.md)
...
- Toda versão aprovada vai para `review/p06.out.md` via **Write** (sobrescreve o arquivo inteiro com o parágrafo atualizado, preservando links markdown).
...
5. **Ao aprovar: Write no `review/p06.out.md`** com o parágrafo completo, links preservados.
6. Próximo achado.
...
1. Confirma que `review/p06.out.md` reflete a última versão aprovada (re-Write se necessário)
2. Imprime: `✓ parágrafo 06 pronto — review/p06.out.md`
3. Aguarda. Ele pode voltar com ajustes a qualquer momento.

## Agora

Carrega o contexto em paralelo. Depois:
1. Mostra o parágrafo 06 em prosa plana (sem links)
