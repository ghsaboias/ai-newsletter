#!/bin/bash
#
# Research: Hardware & compute cluster only
#
# Usage: ./research-hw.sh              # today's date
#        ./research-hw.sh 2026-03-07   # specific date
#
...
init_day_dir
OUTFILE="$DAY_DIR/research-hw.json"
...
CATEGORIES="Hardware & compute (chips, data centers, energy), robotics & physical AI (humanoids, autonomous vehicles, drones), space & orbital compute."
