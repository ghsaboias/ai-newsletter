#!/bin/bash
#
# Research: World cluster only
#
# Usage: ./research-world.sh              # today's date
#        ./research-world.sh 2026-03-07   # specific date
#
...
init_day_dir
OUTFILE="$DAY_DIR/research-world.json"
...
CATEGORIES="Geopolitics & military, economics & labor (layoffs, funding, market moves), biotech & longevity."
