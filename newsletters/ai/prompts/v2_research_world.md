...
Your output will be merged with other clusters (AI, HW) into the final research file.
...
5. Your output file is `pipeline/output/ai/<today>/research-world.json`.
...
Write to `pipeline/output/ai/<today>/research-world.json`. Format:
